...
%TODO
%why template -> becaus EEROS matrices are fixed length. With this solution, the dimension of a EEROS matrix can be adjusted in the Control System.

\subsection{Using a ROS block in the Control System}
%TODO

\subsection{Creating a new ROS subscriber block}
%TODO verweisen auf konkreten block als beispiel
...
\textbf{Adding a new data field an an EEROS input}
\begin{enumerate}[\hspace{0.5cm}{B}-1]
