...
Das es aber, wenn man die benutzerdefinierten Nachrichten dazu zählt, eine unbegrenzte Anzahl von verschiedenen Nachrichtentypen gibt, ist diese Lösung nicht brauchbar. %TODO satzbau
